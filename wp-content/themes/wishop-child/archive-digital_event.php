...
<div class="case-bg" style="background-image:url(<?php echo get_option('wisho_op_theme_header_background_sub_page') ?>)">
		<div <?php post_class( esc_attr( $container )); ?>  id="content" tabindex="-1">
			<h1 class="entry-title"> Materiali dai webinar</h1>
		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<?php if ( have_posts() ) : ?>
					...
					<h1 class="page-title mt-3 mb-3">Materiali dai webinar</h1>
						<?php
					...
					<?php while ( have_posts() ) : the_post(); ?>
						 ...
						 */
						get_template_part( 'loop-templates/content', 'digital_event' );
						?>
