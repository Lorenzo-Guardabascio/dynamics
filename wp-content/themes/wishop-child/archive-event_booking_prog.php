<?php
/**
 * Template Name: Event booking prog
			...
			<main class="site-main" id="main">
				...
				<?php if ( have_posts() ) : ?>
					...
					<h1 class="page-title mt-3 mb-3 d-none">30 minuti con</h1>
						...
						?>
						<div class="taxonomy-description intro">Gli Esperti di Dynamics a vostra disposizione «live» ogni mese per 30 minuti per discutere di una tematica di interesse comune.
<br> Prenota la tua partecipazione e invia le tue domande. <b>Prenota la tua partecipazione ed invia le tue domande</b>.</div>
			...
			<?php get_template_part( 'sidebar-templates/sidebar', 'right-event' ); ?>
		</div> <!-- .row -->
