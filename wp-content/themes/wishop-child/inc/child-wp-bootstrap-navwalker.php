...
if ( ! class_exists( 'Understrap_Child_WP_Bootstrap_Navwalker' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Understrap_Child_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$class_names = $class_names ? ' class="ugolo' . esc_attr( $class_names ) . '"' : '';
